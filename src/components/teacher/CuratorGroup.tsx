...
const CuratorGroup = () => {
  ...
  const handleSendMessage = () => {
    if (messageRecipient === "group") {
      alert(
        `Сообщение отправлено в��ей группе ${currentGroup.name}: "${messageText}"`,
      );
    } else {
    ...
    <div className="space-y-6">
      ...
      {selectedStudent && (
        ...
        >
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        },
                        {
                          date: "08.01.2024",
                          subject: "Математика",
                          reason: "Семейные обстоятель��тва",
                          justified: true,
                        },
                      ].map((absence, index) => (
                        <div
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <div className="border-t pt-4 mt-6">
                    ...
                    <div className="space-y-3">
                      <Textarea
                        placeholder="Оставьте комментарий о сту��енте..."
                        rows={3}
                      />
                      <div className="flex gap-2">
                        <Button size="sm">
          ...
          <Tabs defaultValue="info" className="w-full">
            <TabsList
              className={`grid w-full ${isMobile ? "grid-cols-2" : "grid-cols-5"}`}
            >
              <TabsTrigger value="info">
                {isMobile ? "Инфо" : "Основ��ое"}
              </TabsTrigger>
              <TabsTrigger value="grades">
                {isMobile ? "Оценки" : "Успеваемость"}
              </TabsTrigger>
              {!isMobile && (
                <TabsTrigger value="attendance">Посещаемость</TabsTrigger>
              )}
              ...
              <div className={`grid ${getFormCols()} gap-4`}>
                <div className="space-y-3">
                  ...
                  <div className="text-sm space-y-2">
                    <div>
                      <strong>ФИО:</strong> {selectedStudent.name}
                    </div>
                    <div>
                      <strong>Группа:</strong> {currentGroup.name}
                    </div>
                    <div>
